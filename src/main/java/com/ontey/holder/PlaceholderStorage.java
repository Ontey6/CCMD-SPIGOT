...
class PlaceholderStorage {
   ...
   static List<Placeholder> getPlayerPlaceholders(Player p) {
      ...
      out.add(ph("player.max-health", safe(() -> p.getAttribute(Attribute.GENERIC_MAX_HEALTH).getValue())));
      ...
      out.add(ph("player.x-precise", p.getLocation().getX()));
      out.add(ph("player.y-precise", p.getLocation().getY()));
      out.add(ph("player.z-precise", p.getLocation().getZ()));
      out.add(ph("player.x", (int) p.getLocation().getX()));
      out.add(ph("player.y", (int) p.getLocation().getY()));
      out.add(ph("player.z", (int) p.getLocation().getZ()));
      ...
      out.add(ph("player.pitch", p.getLocation().getPitch()));
      out.add(ph("player.yaw", p.getLocation().getYaw()));
      // body yaw unavailable on spigot
      out.add(ph("player.direction", getDirection(p.getLocation().getYaw())));
